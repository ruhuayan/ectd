...
(function(factory, undefined) {
    ...
    $.fn.resize = function fnResizable(options) {
        var opt = {
            enabled: true,
            minWidth: null, 
            maxWidth: null,
        ...
        return this.each(function () {if(!opt.enabled) return false;
            ...
            function doDrag(e) {
                ...
                if (opt.resizeHeightFrom === 'top')
                    ...
                    newHeight = startPos.height + pos.y - startPos.y;
                if(opt.minWidth && newWidth <opt.minWidth ) return;
                if(opt.maxWidth && newWidth>opt.maxWidth) return;
