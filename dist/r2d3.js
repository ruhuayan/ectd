...
var DIMENSION_LONGFORM = {
  ...
  year_built: {
    ...
    "de": "Baujahr",
    "el": "Î­Ï„Î¿Ï‚ ÎºÎ±Ï„Î±ÏƒÎºÎµÏ…Î®Ï‚"
  },
  bath: {
    "en": "bathrooms",
    "pt": "bathrooms",
  ...
  sqft: {
    ...
    "id": "kaki persegi",
    "tr": "square meters",
    "el": "Ï„ÎµÏ„ÏÎ±Î³Ï‰Î½Î¹ÎºÏŒ Ï€ÏŒÎ´Î¹",
    "de": "Quadratmeter"
  ...
  price_per_sqft: {
    ...
    "tr": "price per sqft",
    "el": "Ï„Î¹Î¼Î® Î±Î½Î¬ Ï„ÎµÏ„ÏÎ±Î³Ï‰Î½Î¹ÎºÏŒ Ï€ÏŒÎ´Î¹",
...
var testAccuracyText = function(LANG) {
  switch (LANG) {
    ...
    case 'el':
      return "Î±ÎºÏÎ¯Î²ÎµÎ¹Î± ÎµÎ»Î­Î³Ï‡Î¿Ï…"
    case 'de':
...
var trainingAccuracyText = function(LANG) {
  switch (LANG) {
    ...
    case 'el':
      return "Î±ÎºÏÎ¯Î²ÎµÎ¹Î± ÎµÎºÏ€Î±Î¯Î´ÎµÏ…ÏƒÎ·Ï‚"
    case 'de':
...
var UNIT_CONVERSION = function(value, unit, lang) {
  ...
  switch (lang) {
    case 'ru':
      if (output_unit === 'per mÂ²') { output_unit = 'Ð·Ð° mÂ²'; }
      break;

    case 'fr':
      if (output_unit === 'par mÂ²') { output_unit = 'Ð·Ð° mÂ²'; }
      break;

    case 'es':
      if (output_unit === 'por mÂ²') { output_unit = 'Ð·Ð° mÂ²'; }
      break;

    case 'it':
      if (output_unit === 'al mÂ²') { output_unit = 'Ð·Ð° mÂ²'; }
      break;

    case 'ar':
      if (output_unit === 'Ø¨Ø§Ù„Ù‚Ø¯Ù… Ø§Ù„Ù…Ø±Ø¨Ø¹') { output_unit = 'Ð·Ð° mÂ²'; }
      break;
